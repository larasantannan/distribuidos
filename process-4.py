...
def startReceivingTime(listening_client):
    ...
    while True:
        ...
        #print("Synchronized time at the process 4 is: " + str(Synchronized_time), end = "\n\n")
        ...
        if len(client_data) > 0:
            ...
            for client_addr, client in client_data.items():
                try:
                    ...
                    print("Process new syncronized time ", synchronized_time)
